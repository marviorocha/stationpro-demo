...
<div class="wp-block-group alignfull no-margin-top header-media-inner-post">
	...
	<div class="wp-block-group alignfull" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
		<!-- wp:cover {"url":"<?php echo esc_url(get_parent_theme_file_uri( '/assets/images/inner-header-media.jpg' )); ?>","dimRatio":0,"focalPoint":{"x":"0.52","y":"0.00"},"isDark":true,"className":"is-dark"} -->
			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group alignwide">
						...
						<h1 class="wp-block-heading has-text-align-center wp-block-post-title">The Shop</h1>
						<!-- /wp:heading -->
					</div>
					<!-- /wp:group -->
				</div>
