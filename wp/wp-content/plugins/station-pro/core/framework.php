...
if (! class_exists('ReduxFramework', false)) {
    ...
    class ReduxFramework
    {
         ...
         * @since  1.0.0
         */
        public function __construct(array $sections = [], array $args = [])
        {
            global $pagenow;
         ...
         * @param boolean $array_key Flag to determine array status.
         *
         * @return array
         *
         * @deprecated 4.0.0
         ...
         * @deprecated 4.0.0
         */
        public function get_wordpress_data($type = false, $args = [], $current_value = null)
        {
         ...
         * @return void
         */
        public function set(string $opt_name = '', $values = [])
        {
