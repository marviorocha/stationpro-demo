    ...
    class Redux_Core
    {
        ...
        public static function instance()
        {
            if (!self::$instance) {
                ...
                add_action('plugins_loaded', ['Redux_Core', 'plugins_loaded']);
            }
        ...
        private function init()
        {
            ...
            self::$upload_url = str_replace(['https://', 'http://'], '//', $upload_dir['baseurl'] . '/redux/');
        ...
        private function includes()
        {
            ...
            include_once dirname(__FILE__) . '/inc/classes/class-redux-path.php';
            include_once dirname(__FILE__) . '/inc/classes/class-redux-functions-ex.php';
            include_once dirname(__FILE__) . '/inc/classes/class-redux-helpers.php';
            include_once dirname(__FILE__) . '/inc/classes/class-redux-instances.php';
            include_once dirname(__FILE__, 2) . '/app/freemius.php';
            ...
            Redux_Functions_Ex::register_class_path('Redux', dirname(__FILE__) . '/inc/player');
        ...
        public function add_debug_info(array $debug_info): array
        {
            ...
            if (!class_exists('ReduxBrowser')) {
                include_once self::$dir . 'inc/lib/browser.php';
            }
            ...
            $debug_info['wp-filesystem']['fields'][] = [
                ...
                foreach ($redux as $inst => $data) {
                    ...
                    if (!empty($ext) && is_array($ext)) {
                        ...
                        foreach ($ext as $name => $arr) {
                            ...
                            $ex = esc_html(ucwords(str_replace(['_', '-'], ' ', $name)));
                    ...
                    $debug_info['redux-instance-' . $inst] = [
        ...
        public function register_classes(string $class_name)
        {
            ...
            if (!class_exists('Redux_Functions_Ex')) {
                include_once Redux_Path::get_path('/inc/classes/class-redux-functions-ex.php');
            }

            if (!class_exists($class_name)) {
                // Backward compatibility for extensions sucks!
                if ('Redux_Instances' === $class_name) {
                    include_once Redux_Path::get_path('/inc/classes/class-redux-instances.php');
                    include_once Redux_Path::get_path('/inc/lib/redux-instances.php');
                ...
                // Load Redux APIs.
                if ('Redux' === $class_name) {
                    include_once Redux_Path::get_path('/inc/classes/class-redux-api.php');
                ...
                if ('Redux_ThemeCheck' === $class_name) {
                    include_once Redux_Path::get_path('/inc/themecheck/class-redux-themecheck.php');

                    return;
                }

                if ('Redux_Welcome' === $class_name) {
                    include_once Redux_Path::get_path('/inc/welcome/class-stationpro-welcome.php');

                    return;
                }

                if ('Redux_Player' === $class_name) {
                    include_once Redux_Path::get_path('/inc/player/class-station-player.php');
