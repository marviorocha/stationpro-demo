        ...
        public function render()
        {
            ...
            if (isset($this->value['redux_repeater_data']) && is_array($this->value['redux_repeater_data']) && ! empty($this->value['redux_repeater_data'])) {
                ...
                foreach ($repeaters as $repeater) {
                    ...
                    echo '<input type="hidden" name="' . esc_attr($this->parent->args['opt_name']) . '[' . esc_attr($this->field['id']) . '][redux_repeater_data][' . esc_attr($x) . '][title]" value="' . esc_attr($repeater['title']) . '" class="regular-text input slide-title" data-key="' . esc_attr($x) . '" />';
            ...
            if (0 === $x || ( isset($this->field['static']) && ( $x - 1 ) < $this->field['static'] )) {
                ...
                while ($loop > 0) {
                    ...
                    echo '<input type="hidden" name="' . esc_attr($this->parent->args['opt_name']) . '[' . esc_attr($this->field['id']) . '][redux_repeater_data][' . intval($x) . '][title]" value="" class="regular-text input slide-title" />';
