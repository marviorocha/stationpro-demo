...
(function ( factory ) {
        ...
        Timepicker.prototype,
        {
            ...
            */
            _afterInject: function () {
                ...
                if ( 'function' === typeof o.afterInject ) {
            ...
            */
            _injectTimePicker: function () {
                var $dp = this.inst.dpDiv, o = this.inst.settings, tp_inst = this, litem = '', uitem = '', show = null, max = {}, gridSize = {}, size = null, i = 0,
                    l   = 0;
                    ...
                    for ( i = 0, l = tp_inst.units.length; i < l; i++ ) {
                        ...
                        if ( show && o[litem + 'Grid'] > 0 ) {
                            ...
                            $tp.find('.ui_tpicker_' + litem + ' table').css(
                                ...
                                'click',
                                function () {
                                    var $t = $(this), h = $t.html(), n = parseInt(h.replace(/[^0-9]/g), 10), ap = h.replace(/[^apm]/ig), f = $t.data('for'); // loses scope, so we use data-for.
                                ...
                                {
                                    cursor: 'pointer', width: (100 / gridSize[litem]) + '%', textAlign: 'center', overflow: 'hidden'
                                }
                            );
                        } // end if grid > 0
                    } // end for loop
                                        ...
                                        $tp.find('table:visible').each(
                                            function () {
                                                var $g                                  = $(this), oldWidth = $g.outerWidth(),
                                                    ...
                                                    newWidth                            = oldWidth - sliderAccessWidth, newMarginLeft = ((oldMarginLeft * newWidth) / oldWidth) + '%',
            ...
            */
            _onTimeChange: function () {
                ...
                var hour             = (this.hour_slider) ? this.control.value(this, this.hour_slider, 'hour') : false,
                    ...
                    pickerTimeFormat = o.pickerTimeFormat || o.timeFormat, pickerTimeSuffix = o.pickerTimeSuffix || o.timeSuffix;
            ...
            */
            _updateDateTime: function ( dp_inst ) {
                ...
                /*
                * remove following lines to force every change in date picker to change the input value
                ...
                */
                ...
                if ( ! this._defaults.showTimepicker ) {
                    ...
                    var altFormattedDateTime = '', altSeparator = this._defaults.altSeparator !== null ? this._defaults.altSeparator : this._defaults.separator,
        ...
        if ( tp_inst ) {
            if ( $.datepicker._get(inst, 'constrainInput') ) {
                var ampm          = tp_inst.support.ampm,
                    ...
                    .replace(/T/g, ampm ? 'AP' : '')
                    .replace(/tt/g, ampm ? 'apm' : '')
                    .replace(/t/g, ampm ? 'ap' : '') + ' ' + tp_inst._defaults.separator + tp_inst._defaults.timeSuffix +
                        (tz ? tp_inst._defaults.timezoneList.join('') : '' ) + ( tp_inst._defaults.amNames.join('') ) + ( tp_inst._defaults.pmNames.join('') ) + dateChars,
    ...
    */
    ...
    $.datepicker._formatDate = function ( inst ) {
        var tp_inst = this._get(inst, 'timepicker');
        if ( tp_inst ) {
            tp_inst._updateDateTime(inst);
 ...
 // does the format contain the token?
    ...
    */
    var splitDateTime = function ( dateTimeString, timeSettings ) {
        ...
        if ( allPartsLen > 1 ) {
            return {
                dateString: allParts.splice(0, allPartsLen - timePartsLen).join(separator), timeString: allParts.splice(0, timePartsLen).join(separator)
            };
        }
    ...
    */
    ...
    $.timepicker.timezoneOffsetNumber = function ( tzString ) {
        ...
        return ((normalized.substring(0, 1) === '-' ? -1 : 1) * // plus or minus
            ((parseInt(normalized.substring(1, 2), 10) * 60) + // hours (converted to minutes)
                parseInt(normalized.substring(3, 2), 10))); // minutes
    };
