...
(function ( factory ) {
    ...
    $.fn.serializeJSON = function ( options ) {
        var f     = $.serializeJSON;
        var _this = this;
        // NOTE: the set of matched elements is most likely a form, but it could also be a group of inputs.
        ...
        $.each(
            ...
            function ( _i, obj ) {
                ...
                typedValue = f.applyTypeFunc(obj.name, obj.value, type, obj.el, typeFunctions);
                // Parse type as string, number, etc.
                if (! typedValue && f.shouldSkipFalsy(obj.name, nameSansType, type, obj.el, opts)) {
                    return;
                    // Ignore falsy inputs if specified in the options.
                }
    ...
    $.serializeJSON = {
        ...
        defaultBaseOptions: {
            ...
            // Tip: name="foo[2]" value="v" => {foo: [null, null, "v"]}, instead of {foo: ["2": "v"]}.
            ...
            defaultTypes: {
                ...
                'skip': null
                // Skip is a special type used to ignore fields.
            },
            defaultType: 'string'
        },
        ...
        serializeArray: function ( _this, opts ) {
            ...
            return _this.map(
                function () {
                    elements = $.prop(this, 'elements');
                    // Handle propHook "elements" to filter or add form elements.
        ...
        shouldSkipFalsy: function ( name, nameSansType, type, el, opts ) {
            ...
            if (skipFromDataAttr != null) {
                ...
                // any value is true, except the string "false".
            }
        ...
        deepSet: function ( o, keys, value, opts ) {
            ...
            if (1 === keys.length) {
                if (key === '') {
                    ...
                    o[key] = value;
                    // Keys can be object keys (strings) or array indexes (numbers).
                }
            ...
            // List of all other nested keys (nextKey is first).
            if (key === '') {
                ...
                if (isObject(lastVal) && isUndefined(f.deepGet(lastVal, tailKeys))) {
                    key = lastIdx;
                    // then set the new value as a new attribute of the same object.
                } else {
                    key = lastIdx + 1;
                    // otherwise, add a new element in the array.
                }
            }
            ...
            if (nextKey === '') {
                ...
                if (isUndefined(o[key]) || ! isArray(o[key])) {
                    o[key] = [];
                    // define (or override) as array to push values.
                }
            } else {
                if (opts.useIntKeysAsArrayIndex && isValidArrayIndex(nextKey)) {
                    ...
                    if (isUndefined(o[key]) || ! isArray(o[key])) {
                        o[key] = [];
                        // Define (or override) as array, to insert values using int keys as array indexes.
                    }
                } else {
                    // nextKey is going to be the nested object's attribute.
                    if (isUndefined(o[key]) || ! isObject(o[key])) {
                        o[key] = {};
                        // Define (or override) as object, to set nested properties.
                    }
                }
            }//end if
