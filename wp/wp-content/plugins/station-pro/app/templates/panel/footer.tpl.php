...
<div id="redux-footer-sticky">
    <div  id="sp-redux-footer">
        ...
        <div class="redux-action_bar">
            ...
            //  submit_button( esc_html__( 'Save Changes', 'redux-framework' ), 'primary', 'redux_save', false, array( 'id' => 'redux_bottom_save', 'class'=> 'button  is-primary' ) );
            // }
