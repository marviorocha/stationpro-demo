...
<?php if (isset($this->parent->args['intro_text'])) { ?>
        <div class="" id="redux-intro-text"><?php echo wp_kses_post($this->parent->args['intro_text']); ?></div>
<?php } ?>
...
<div class="redux-main">
    ...
    <?php foreach ($this->parent->sections as $k => $section) { ?>
        ...
        <div id="<?php echo esc_attr($k); ?>_section_group" class="redux-group-tab <?php echo esc_attr($disabled); ?><?php echo esc_attr($section['class']); ?>" data-rel="<?php echo esc_attr($k); ?>">
